...
print(res)
```
predictDF <- data.frame(predicted = predictRF, actual = test$PH)
predictDF$Delta <-  predictDF$actual - predictDF$predicted
predictDF$MAPE <- abs(predictDF$Delta)/predictDF$actual
predictDF$SqErr <- (predictDF$predicted - predictDF$actual)^2
mean(predictDF$SqErr)
